...
class OrderRepositoryTest {
    ...
    void setup() {
        ...
        Order order1 = new Order("13652556-012a-4c87-b546-54eb1396d79b",
                products, 1788568080L, "Safira Sudrajat");
        orders.add(order1);
        Order order2 = new Order("7f9e15bb-4b15-42f4-aebc-c3af385fb078",
                products, 1788576000L, "Safira Sudrajat");
        orders.add(order2);
        Order order3 = new Order("e334ef40-9eff-4da8-9487-8ee697ecbfle",
                products, 1798570000L, "Bambang Sudrajat");
        orders.add(order3);
    }
